...
const promptAiToInsert:PromptAiArrayType = [
    {   sitePublication:    'cronacalive.it', 
        calls:              [{"getStructure":0},{"getArticle":0}],
