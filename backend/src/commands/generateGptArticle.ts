            ...
            case 'acquistigiusti.it':   
                try {                    
                    ...
                    if( nextArticleGenerate !== null && nextArticleGenerate.article !== null && nextArticleGenerate.site !== null) {
                        ...
                        await openAiService.runPromptAiArticle(alertProcess, processName, 'acquistigiusti.it', "668060f54c7ad7402d5636ca", 0, null);
            ...
            case 'bluedizioni.it':    
                try {
                    ...
                    if( nextArticleGenerate !== null && nextArticleGenerate.article !== null && nextArticleGenerate.site !== null) {
                        ...
                        const alertProcess:string               			= openAiService.alertUtility.initProcess(processLabel); //. date('YmdHis')
                        openAiService.alertUtility.setLimitWrite(60000);
                        await openAiService.runPromptAiArticle(alertProcess, processName, 'bluedizioni.it', "65fdb1790b624b6378727c21", 0, null);
